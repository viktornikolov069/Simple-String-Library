# 0 "src/dynamic_string.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "src/dynamic_string.c"
# 1 "include/dynamic_string.h" 1
...
# 25 "include/dynamic_string.h"
    ...
    size_t (*getSize)(const struct DynamicString*);
    const char* (*getStrImmutable)(const struct DynamicString*);
    void (*destStr)(const struct DynamicString*);
    struct DynamicString*(*copy)(const struct DynamicString*);

} DynamicString_t;

size_t get_size(const struct DynamicString*);

const char* get_str_immutable(const struct DynamicString*);

void dest_str(const struct DynamicString*);

DynamicString_t* copy(const struct DynamicString*);



DynamicString_t* InitDynamicString(const char *str);
# 2 "src/dynamic_string.c" 2
...
# 4 "src/dynamic_string.c" 2



# 6 "src/dynamic_string.c"
